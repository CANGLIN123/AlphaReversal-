...
config = {
    ...
    'min_score': 50,
    'score_weights': {
        'j_value': 0.12, 'volume_pattern': 0.18,
        'bbi_trend': 0.17, 'reversal': 0.13,
        'hot_industry': 0.11, 'ma60_proximity': 0.10,
        'amihud': 0.06, 'turnover': 0.06,
        'limit_dist': 0.04, 'quality': 0.03,
    },
}
